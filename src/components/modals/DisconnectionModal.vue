<template>
  <div v-if="serialStore.showConnectionLostModal" class="modal-backdrop" @click.stop>
    <div class="modal disconnection-modal" @click.stop>
      <h2>Timer Disconnected</h2>
      ...
      <p class="disconnect-message">
        The timer has been disconnected. This may be due to:
      </p>

      <ul class="disconnect-reasons">
        <li>USB cable was unplugged</li>
        <li>Timer device was powered off</li>
...
async function handleReconnect() {
  ...
  try {
    ...
    serialStore.showConnectionLostModal = false
  } catch (error) {
