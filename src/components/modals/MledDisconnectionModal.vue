<template>
  <div v-if="mledStore.showConnectionLostModal" class="modal-backdrop" @click.stop>
    <div class="modal disconnection-modal" @click.stop>
      <h2>FDS Display Disconnected</h2>
      ...
      <p class="disconnect-message">
        The FDS display has been disconnected. This may be due to:
      </p>
...
async function handleReconnect() {
  ...
  try {
    ...
    mledStore.showConnectionLostModal = false
  } catch (error) {
